...
The tensegrity app has an impressive realism to it, but making this work properly is remarkably uncomplicated. The core is a single simple idea: the *Elastic Interval* which is a thing which holds on to two points in 3D space.
