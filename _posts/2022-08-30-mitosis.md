...
This archetypal structure is one any tensegrity builder will recognize.
...
The Omni-twist was applied to split and rejoin the structure of "Convergence", for example.
...
what Flemons' structure would be like, built in this way with **tough tension**.

## I want one in my hands

My first step was to make a virtual model in code, so I could read out the exact lengths that I would need.
...
The end result was **very fascinating indeed**, because with a tensegrity object you can make it loose or tighten it
